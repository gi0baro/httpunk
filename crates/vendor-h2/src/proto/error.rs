...
impl Error {
    ...
    pub fn user_go_away(reason: Reason) -> Self {
    ...
    pub fn remote_reset(stream_id: StreamId, reason: Reason) -> Self {
        Self::Reset(stream_id, reason, Initiator::Remote)
    }

    pub fn remote_go_away(debug_data: Bytes, reason: Reason) -> Self {
